...
public class AuthorizationServerConfig {
	...
	@Bean
	public ProviderSettings providerSettings(ServiceSecurityProperties properties) {
	...
	public RegisteredClientRepository registeredClientRepository(PasswordEncoder passwordEncoder) {
		...
		RegisteredClient serviceBackend = RegisteredClient
				.withId("1")
				.clientId("admin")
		...
		return new InMemoryRegisteredClientRepository(Collections.singletonList(serviceBackend));
	}
